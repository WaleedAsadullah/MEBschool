                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30" style="text-align: center; font-size: 22px"> Feedback Form</h4>
                                        ...
                                        <br>
                                        <form action="Parents-mod-feedback.php#formadd" method="post" id="submitted2">
...
<?php if(isset($_REQUEST['settype'])){
    ...
    echo '
                                    <form action="Parents-mod-feedback.php#formadd" method="post" id="submitted">';
...
?>
                                    ...
                                    <form method="post" action="Parents-mod-feedback.php"  >
