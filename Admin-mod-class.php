...
?>
                            ...
                            <div class="col-lg-12">
                                <div class="card-box table-responsive">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Classes </h4>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            $sql = 'INSERT INTO `ad_class`(`class_id`, `class_name`, `comment`) VALUES (NULL,\''.$_REQUEST['class_name'].'\', \''.$_REQUEST['comment'].'\')';
                                            insert_query($sql);
                                                }
                                            // -------------------
                                            ...
                                            $sql = 'SELECT `class_id`"ID" , `class_name` "Class Name", `comment` "Comments" FROM `ad_class`';
                                            display_query($sql);
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Class </h4>
