...
if(isset($_POST["submit"])) {
  $check = getimagesize($_FILES["img_link"]["tmp_name"]);
  if($check !== false) {
...
// Check file size
if ($_FILES["img_link"]["size"] > 2000000) {
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["img_link"]["tmp_name"], $target_file)) {
    echo "The file ". basename( $_FILES["img_link"]["name"]). " has been uploaded.";
    $uploadedok = true;
  } else {
     $uploadedok = false;
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <br>
                                    <form action="teacher-mod-blog.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                                <div style="align-content: center;">
                                                    <h4 class="header-title m-t-0 m-b-30">Blog Image</h4>
                                                    <?php if (isset($_REQUEST['img_link'])) echo "<img class = 'img1' style = 'height:190px ;' src=".$_REQUEST['img_link'].">";  ?>
                                                    <input id="img_link" name="img_link" type="file" class="dropify" data-max-file-size="10M" required="" />
                                                </div>
                                            </div>
