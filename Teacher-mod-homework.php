                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form action="teacher-mod-homework.php" method="post" enctype="multipart/form-data">
                                        ...
                                        dropDownConditional("Class","class","teacher_assign_id","assign_class","ad_teacher_assign",NULL);


                                        // ---- subject

                                        dropDownConditional("Subject","subject","teacher_assign_id","assign_subject","ad_teacher_assign",NULL);
