                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <br>
                                        <form action="Teacher-mod-feedback.php#formadd" method="post" id="submitted2">
...
<?php if(isset($_REQUEST['settype'])){
    ...
    echo '
                                    <form action="Teacher-mod-feedback.php#formadd" method="post" id="submitted">';
                                    if (isset($_REQUEST['settype']) ) echo '<input type="hidden" value="'.$_REQUEST['settype'].'" name="settype">';
...
?>
                                    <form method="post" action="Teacher-mod-feedback.php"  >
