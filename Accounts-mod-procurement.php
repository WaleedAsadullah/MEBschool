                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Procurement </h4>
                                    <br>
                                    <form action="Accounts-mod-procurement.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="hbDateOfBooking">Date Request</label>
                                            <input type="date" name="date_req" required=""  class="form-control" id="prVacation" value="<?php if (isset($_REQUEST['date_req'])) echo $_REQUEST['date_req']; else echo (date("Y-m-d")); ?>">
                                        </div>
                                        ...
                                        <input type="hidden" name="date_approved" value="">

                                        <input type="hidden" name="done_by" value="">

                                        <input type="hidden" name="on_date" value="">
